...
var superFunction = function(number){
	var half = halfNumber(number);
	var square = squareNumber(half);
	var area = areaOfCircle(square);
	var percent = percentOf(area, square);

	console.log("Half of " + number + " is " + half + ", square of " + half + " is " + square + ", area of " + square + " is " + area + ", percent of " + area + " over " + square + " is " + percent + " % ");
}
