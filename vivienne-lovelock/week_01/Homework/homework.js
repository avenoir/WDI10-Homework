...
// OR var squareNumber = function (num1) { //  squareNUmber = num1 * num1  //
}
...
function percentOf (num1,num2){      
	var percentOf = (num1/num2=0.50);     
	return () 
 }

var return = (num1+ percentOf +num2)  console.log(return)




//Write a function called areaOfCircle that will  take one argument (the
//radius), calculate the area based on that, and return  the result. It should
//also log a string like "The area for a circle with  radius 2 is
//12.566370614359172." Bonus: Round the result so there are only two  digits
//after the decimal.



function areaOfCircle (){     var radius = 15;     var circumference = 2 *
3.141592 * radius; }

console.log('The area for a circle with radius' + circumference ); var
area=Math.PI * radius * radius;

//to.fixed - to round to nearest decomal point
...
// Take half of the number and store the result. Square the result of #1 and
// store that result. Calculate the area of a circle with the result of #2 as
// the radius. Calculate what percentage that area is of the squared result
// (#3). Strings These exercises will test your knowledge of string functions,
...
//   DrEvil(10): 10 dollars //   DrEvil(1000000): 1000000 dollars (pinky) 

var DrEvil function = (amount) {
	if (amount>=1000000) {
		return= ('DrEvil' + amount + 'pinky');
	}else if (amount<=1000000) {
	return=('DrEvil' + amount+);
}
console.log('DrEvil');
...
// Look up the JavaScript string reference to find methods which may be
//useful! 
...
// string, and return a version where all occurences of its first character
...
//   verbing('swim'): 'swimming' //   verbing('swimming'): 'swimmingly' //
//verbing('go'): 'go' // //  


//Not Bad
// Create a function called notBad that takes a single argument, a string.
// // It should find the first appearance of the substring 'not' and 'bad'. If
// // the 'bad' follows the 'not', then it should replace the whole
// // 'not'...'bad' substring with 'good' and return the result. If it doesn't
// // find 'not' and 'bad' in the right sequence (or at all), just return the
// // original sentence. For example:

//   notBad('This dinner is not that bad!'): 'This dinner is good!'
//   notBad('This movie is not so bad!'): 'This movie is good!' notBad('This
//   dinner is bad!'): 'This dinner is bad!'
